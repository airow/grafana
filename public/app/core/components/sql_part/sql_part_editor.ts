...
export function sqlPartEditorDirective(templateSrv: any) {
  ...
  return {
    ...
    link: function postLink($scope: any, elem: any) {
      ...
      function inputBlur($input: any, paramIndex: number) {
        cancelBlur = setTimeout(() => {
          switchToLink($input, paramIndex);
        }, 200);
      }

      function switchToLink($input: any, paramIndex: number) {
        /*jshint validthis:true */
      ...
      function addTypeahead($input: any, param: any, paramIndex: number) {
