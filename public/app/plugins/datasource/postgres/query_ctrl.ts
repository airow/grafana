...
export class PostgresQueryCtrl extends QueryCtrl {
  ...
  constructor(
    ...
    this.panelCtrl.events.on('data-received'/*PanelEvents.dataReceived*/, this.onDataReceived.bind(this), $scope);
    this.panelCtrl.events.on('data-error'/*PanelEvents.dataError*/, this.onDataError.bind(this), $scope);
  }
