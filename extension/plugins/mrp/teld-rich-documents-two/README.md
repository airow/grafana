## RichDocumentsTwo Panel Plugin for Grafana

The RichDocumentsTwo Panel can show the current time or a countdown and updates every second.
...
- **Date/Time formatting options**:
  ...
  The font size, weight and date/time formatting can be customized here. If the seconds ticking annoys you then change the time format to HH:mm for the 24 hour RichDocumentsTwo or h:mm A for the 12 hour RichDocumentsTwo.

- **Bg Color**:

  Choose a background color for the RichDocumentsTwo with the color picker.

### Screenshots

- [Screenshot of two RichDocumentsTwo and a countdown](https://raw.githubusercontent.com/grafana/rich-documents/06ecf59c191db642127c6153bc3145e93a1df1f8/src/img/screenshot-clocks.png)
